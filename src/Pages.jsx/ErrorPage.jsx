...
export default function ErrorPage() {
  return (
    <>
   <Breadcrum title='404-Page Not Found' description={"The page you’re looking for doesn’t exist or may have been moved. At Heritage Ally, we’re always working to bring you the finest collection of traditional and modern products, but it seems this page took a different path. Don’t worry—you can head back to our homepage or explore our collections to discover something special. If you believe this is an error, feel free to contact us."}/>
